...
#scroll{
          ...
          <div class="col-md-12 mb-3">
            <div class="card">
              <div class="card-header">
                <span><i class="bi bi-table me-2"></i></span>Previous Elections
              </div>
              <div class="card-body">
	...
	<th>Voted Individuals</th>
	<th>Unvoted Individuals</th>
	<th>Results</th>
</tr>
</thead>
<tbody>
...
?>
  <tr>
	...
	<td><?php echo $row['voted_voters'];?></td>
	<td><?php echo $row['unvoted_voters'];?></td>
	<?php 
	$year=$row['Year'];
	$state=$row['State'];
	$url = "oldres.php?year=$year & state=$state";?>
	<td> <a class="editbtn-text" href="<?php echo $url?>">
