...
<a class="btn btn-sm btn-danger" style ="background-color:#228B22; border:1px solid #228B22;" href="voted.php">
  ...
  <button class="" style="background:transparent; border:none;">
<a class="btn btn-sm btn-danger" style ="background-color:#DC143C; border:2px solid black;" href="unvoted.php">
	Unvoted
</a>
</button>
  <button class="" style="background:transparent; border:none;">
...
<div class="card-header">
                <span><i class="bi bi-table me-2"></i></span>Voters-Unvoted 
              </div>
			  <div class="card-body">
