...
<a class="btn btn-sm btn-danger" style ="background-color:#228B22; border:2px solid black;" href="voted.php">
	voted
</a></button>
...
</div><?php } else if($fet['election_status']==3){
...
<div class="card-header">
                <span><i class="bi bi-table me-2"></i></span>Voters- Voted
              </div>
			  <div class="card-body">
...
<tbody>
 ...
 <?php
 $sql = "SELECT * from tbl_voters where status=5";
