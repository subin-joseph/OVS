...
if (isset($_POST['print'])){
   require('../../../mpdf/vendor/autoload.php');
    $query="SELECT * from tbl_candidate where Status=-1";
    ...
    if(mysqli_num_rows($queryRes)>0){
        ...
        $html='<style>
                ...
                <div class="heading">Rejected Candidates</div>
...
<html lang="en">
  <head>
    ...
    <title>Admin-Rejected Candidates</title>
    <!-- plugins:css -->
          ...
          <div class="navbar-menu-wrapper d-flex align-items-stretch">
            ...
            <ul class="navbar-nav navbar-nav-right">
			  ...
			  <a class="btn btn-sm btn-danger" 
			  	style="background:#009E60; border:none;" href="approved_cand.php">Approved
</a>&nbsp;&nbsp;
<a class="btn btn-sm btn-danger" style="border:2px solid black;" href="rejected_cand.php">
Rejected
</a>
