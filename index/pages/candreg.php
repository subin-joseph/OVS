...
<html lang="en">
  <head>
    ...
    <title>Admin-Registered Candidates</title>
    <!-- plugins:css -->
        ...
        <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
          <div class="navbar-menu-wrapper d-flex align-items-stretch">
            ...
            <ul class="navbar-nav navbar-nav-right">
			  ...
			  style="border:none; background:#009E60;" href="approved_cand.php">Approved
</a>&nbsp;&nbsp;
<a class="btn btn-sm btn-danger" style="border:none;" href="rejected_cand.php">
Rejected
</a>
...
<tr><th>Photo</th>
 ...
 if ($result->num_rows > 0) {
  ...
  <tr>
	...
	<td> <a class="editbtn-text" href="cand_docview.php?id=<?php echo $row['login_id'];?>">
